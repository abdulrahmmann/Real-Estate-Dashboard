                        ...
                        <div className={`mt-10 md:mt-0 max-w-full w-full md:max-w-[540px]`}>
                            ...
                            <div className={`mt-7`}>
                                <div className="grid w-full items-center gap-1.5 mb-5">
                                    ...
                                    <Input type="text" id="Address" placeholder="Address" className={`text-xs`}/>
                                </div>
                                ...
                                <div className={`grid grid-cols-1 sm:grid-cols-2 gap-5`}>
                                    <div className="grid w-full items-center gap-1.5">
                                        ...
                                        <Input type="tel" id="PhoneNumber" placeholder="PhoneNumber" className={`text-xs`}/>
                                    </div>
                                    <div className="grid w-full items-center gap-1.5">
                                        <Label htmlFor="Email"
                                               className={`text-xs text-secondaryTextColor mb-1`}>Email</Label>
                                        <Input type="email" id="Email" placeholder="Email" className={`text-xs`}/>
                                    </div>
                                </div>
                            </div>
                        </div>
