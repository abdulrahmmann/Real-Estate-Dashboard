...
const PropertyDetails  = ({params, searchParams}: any) => {
            ...
            <div className={`bg-whiteColor rounded-xl p-5 w-full h-full`}>
                ...
                <div className={`mt-6`}>
                    <div className={`grid grid-cols-12 gap-5`}>
                        <div className={`col-span-12 lg:col-span-9 lg:max-h-[321px]`}>
                            <div className={`grid grid-cols-12 gap-2 lg:gap-5`}>
                                <div className={`col-span-8 lg:col-span-9`}>
                                    <div>
                                        <img src={`${propertyDetails.images[0]}`} alt={'estate img'} className={`w-full h-[250px] lg:h-[321px] rounded-xl`} />
                                    </div>
                                </div>

                                <div className={`col-span-4 lg:col-span-3 lg:max-h-[321px]`}>
                                    <div className={`flex flex-col justify-between h-[250px] lg:max-h-[321px] lg:min-h-[321px]`}>
                                        <img src={`${propertyDetails.images[1]}`} alt={`estate img`} className={`w-full h-[121px] lg:h-[154px] rounded-xl`} />
                                        <img src={`${propertyDetails.images[2]}`} alt={`estate img`} className={`w-full h-[121px] lg:h-[154px] rounded-xl`} />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <PropertyDetailsUser agent={propertyDetails.agent} agentImage={propertyDetails.agentImage} country={propertyDetails.country} propertis={propertyDetails.propertis} />
                        </div>
                    </div>
                </div>

                <div className={`my-4`}>
                    <PropertyDetailsDescription props={propertyDetails} />
                </div>
